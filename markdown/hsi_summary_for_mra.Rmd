...
2. Import polygon shapefiles delineating the river kilometers and geomorphic reaches as defined in the IRA. These shapefiles are used to interrogate the depth and velocity .tifs to determine which rkm or geomorphic reach each depth and velocity pixel falls within.
...
7. Write out the composite suitability values, rkms and geomorphic reaches for each pixel to a .csv. These results are all stored in the output/hsi_raw/ and output/hsi_rkm/ directories in the `mra_hsi` repository.
