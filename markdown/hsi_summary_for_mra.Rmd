...
```{r rkm-geo-rch}
load(here("data/mra_temp_rkm_redd_data_prepped.Rdata"))
...
rkm_gr %>%
  kable(booktabs = T,
        ...
        River kilometers increase as you move upstream") %>%
  kable_styling()
...
```{r hsi-curves}
hsi_df = read_csv(here("data/hsi_curves/maret_hsi_curves_for_r.csv"))
